...
namespace feeRecipt {
    ...
    public partial class feeDetailsDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow AddStudentRow(string Name, string Course, int Amount, System.DateTime Date) {
...
namespace feeRecipt.feeDetailsDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Student` WHERE ((`ID` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Name" +
                "` = ?)) AND ((? = 1 AND `Course` IS NULL) OR (`Course` = ?)) AND ((? = 1 AND `Am" +
                "ount` IS NULL) OR (`Amount` = ?)) AND ((? = 1 AND `Date` IS NULL) OR (`Date` = ?" +
                ")))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Student` (`Name`, `Course`, `Amount`, `Date`) VALUES (?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Student` SET `Name` = ?, `Course` = ?, `Amount` = ?, `Date` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `Course` IS NULL) OR (`Course` = ?)) AND ((? = 1 AND `Amount` IS NULL) OR (`Amount` = ?)) AND ((? = 1 AND `Date` IS NULL) OR (`Date` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::feeRecipt.Properties.Settings.Default.feeDetailsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Course, Amount, [Date] FROM Student";
        ...
        public virtual int Fill(feeDetailsDataSet.StudentDataTable dataTable) {
        ...
        public virtual feeDetailsDataSet.StudentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            feeDetailsDataSet.StudentDataTable dataTable = new feeDetailsDataSet.StudentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(feeDetailsDataSet.StudentDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(feeDetailsDataSet dataSet) {
        ...
        public virtual int Delete(int Original_ID, string Original_Name, string Original_Course, global::System.Nullable<int> Original_Amount, global::System.Nullable<global::System.DateTime> Original_Date) {
        ...
        public virtual int Insert(string Name, string Course, global::System.Nullable<int> Amount, global::System.Nullable<global::System.DateTime> Date) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Course, global::System.Nullable<int> Amount, global::System.Nullable<global::System.DateTime> Date, int Original_ID, string Original_Name, string Original_Course, global::System.Nullable<int> Original_Amount, global::System.Nullable<global::System.DateTime> Original_Date) {
            if ((Name == null)) {
